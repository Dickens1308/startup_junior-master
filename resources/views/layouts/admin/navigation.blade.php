    ...
    <div class="sidenav h-100 modal-dialog bg-light">
        ...
        <div class="navbar">
            ...
            <a href="/" class="navbar-brand">
                <svg width="32" height="32" viewBox="0 0 512 512" xmlns="#" fill="currentColor">
        ...
        <div class="flex scrollable hover">
            <div class="nav-active-text-primary" data-nav>
                <ul class="nav bg">
                    ...
                    <li>
                        <a href="{{ route('mentor.home') }}">
                            <span class="nav-icon text-primary"><i data-feather='message-circle'></i></span>
                            <span class="nav-text">Messages</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('mentor.home') }}">
                            <span class="nav-icon text-primary"><i data-feather='info'></i></span>
                            <span class="nav-text">Ideas</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('mentor.home') }}">
                            <span class="nav-icon text-primary"><i data-feather='crop'></i></span>
                            <span class="nav-text">Galley</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('mentors') }}">
                            <span class="nav-icon text-primary"><i data-feather='users'></i></span>
                            <span class="nav-text">Mentars</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('mentor.home') }}">
