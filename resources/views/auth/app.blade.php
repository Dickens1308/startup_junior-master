...
<head>
    <meta charset="utf-8" />
    <title>Matches | Football TimeTable</title>
        ...
        <div class=" mx-auto py-5">
            <div class="p-4 d-flex flex-column ">
                ...
                <a href="/" class="navbar-brand align-self-center">
                    ...
                    <span class="hidden-folded d-inline l-s-n-1x align-self-center">Startup Junior</span>
                </a>
                <!-- / brand -->
            </div>
            @yield('content')

            <div class="text-center text-muted">&copy; Copyright. JF</div>
        </div>
    </div>
</body>
